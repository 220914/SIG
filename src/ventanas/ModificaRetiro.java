...
public class ModificaRetiro extends JInternalFrame {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModificaRetiro frame = new ModificaRetiro();
	 ...
	 * Create the frame.
	 */
	public ModificaRetiro() {
		setBounds(100, 100, 450, 300);
		setTitle("Modificar Retiro");
	...
	ModificarBD.registrarretiro(Integer.parseInt(textid.getText()),Integer.parseInt(textdinero.getText()),txtdesc.getText());
	
	}
	public static void rellenarretiro(String id,String  dinero, String descripcion) {
		textid.setText(id);
